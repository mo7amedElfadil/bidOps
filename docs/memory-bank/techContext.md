...
* Pricing data: BoQ + pricing pack rows with custom columns, template configs, and FX rates (base QAR).
...
* AI extraction: OpenAI and Gemini supported for prompt-based proposal/compliance drafts (env-configured).
