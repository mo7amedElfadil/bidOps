...
const update_change_request_dto_1 = require("./dto/update-change-request.dto");
let ChangeRequestsController = class ChangeRequestsController {
    service;
    constructor(service) {
        this.service = service;
    }
    list(opportunityId, status, req) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_change_request_dto_1.UpdateChangeRequestDto]),
    __metadata("design:returntype", void 0)
