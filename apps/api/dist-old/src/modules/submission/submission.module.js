...
const storage_module_1 = require("../../files/storage.module");
...
exports.SubmissionModule = SubmissionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [submission_service_1.SubmissionService, prisma_service_1.PrismaService, tenant_service_1.TenantService]
    })
], SubmissionModule);
